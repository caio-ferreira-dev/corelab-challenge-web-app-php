      ...
      <div className={styles.optionsContainer}>
        <div
          className={`${styles.buttonContainer} ${
            isEditing ? styles.editing : styles.editOption
          }`}
          onClick={handleEdit}
        >
        ...
        <div
          className={`${styles.buttonContainer} ${styles.colorOption} ${
            choosingColor ? styles.selectingColor : ""
          }`}
        >
          <button
            className={`${styles.optionButton} ${styles.colorButton}`}
            onClick={handleColor}
          ></button>
          {choosingColor ? (
            <ColorBar setState={setChoosingColor} setColor={setColor} />
          ) : (
            ""
          )}
        </div>
        <div
          className={`${styles.buttonContainer} ${styles.deleteOption}`}
